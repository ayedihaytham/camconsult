  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground no-print",
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground no-print [&>button]:hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground lg:block no-print"
        data-state={state}
